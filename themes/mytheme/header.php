          ...
          <?php 
                ...
                if( has_nav_menu( 'secondary' ) ){
                    wp_nav_menu([
                        ...
                        'container'                     =>  false,
                        'fallback_cb'                   =>  false,
                        'depth'                         =>  1, // No drop down
                        // 'walker'                        =>  new PD_Custom_Nav_Walker()
                    ]);
                }
          ...
          <div id="top-social">
            <ul>
              <?php
                  ...
                  if( get_theme_mod( 'pd_facebook_handle' ) ){
                      ?>
                        <li>
                          <a href="https://facebook.com/<?php echo get_theme_mod( 'pd_facebook_handle' ); ?>" class="si-facebook">
        ...
        <nav id="primary-menu" class="style-2">
          ...
          <div class="container clearfix">
            ...
            <?php
                ...
                if( get_theme_mod( 'pd_header_show_cart' ) ){
                  ?>
                    <!-- Top Cart
                    ============================================= -->
                    <div id="top-cart">
                      <a href="#" id="top-cart-trigger"><i class="fa fa-shopping-cart"></i><span>5</span></a>
                ...
                if( get_theme_mod( 'pd_header_show_search' ) ){
                  ?>
                    <!-- Top Search
                    ============================================= -->
                    <div id="top-search">
                      <a href="#" id="top-search-trigger">
                        <i class="fa fa-search"></i><i class="icon-line-cross"></i>
                      </a>
                      <form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get">
                        <input type="text" name="q" 
                          class="form-control" 
                          placeholder="<?php __( 'Type &amp; Hit Enter..', 'mytheme') ?>" 
