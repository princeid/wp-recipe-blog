...
function r_save_options(){
    ...
    // Check the nonce generated by wordpress. N/B: This function kills the script if it turns out to be false
    ...
    $recipe_opts[ 'recipe_submission_login_required' ]      =   absint($_POST[ 'r_rating_login_required' ]);
