...
function recipe_create_account(){
    ...
    if(!wp_verify_nonce( $nonce, 'recipe_auth' )){
        wp_send_json( $output ); // Kill the script with the output
    }
    ...
    /* wp_sign_on can do all the above to login a new user but this is a more 
    definite way to allow wordpress and plugins to do additional setup where necessary */
