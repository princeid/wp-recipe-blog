...
// Whatever is outputed from this function will be outputed on the page
function r_plugin_opts_page(){
    $recipe_opts                =   get_option( 'r_opts' );


    ?>
    <!-- The "wrap" class is provided by wordpress -->
    <div class="wrap">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="admin-post.php">
                    ...
                    <!-- To protect this form against XSS injection -->
        ...
        <!-- options.php is exclusively for the "settings" API -->
