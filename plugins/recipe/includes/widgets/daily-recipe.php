...
class R_Daily_Recipe_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'r_daily_recipe_widget', 'Today Recipe', $widget_ops );
	}
    ...
    <p>
        <!-- <div> This is just a comment : the get_field_id() generates an id for our field</div> -->
	...
	public function widget( $args, $instance ) {
		...
		$title					=	apply_filters( 'widget_title', $title ); // widget_title is a filter hook
