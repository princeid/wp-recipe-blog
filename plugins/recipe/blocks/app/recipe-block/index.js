...
registerBlockType( 'prince/recipe', {
    title:                                         __( 'Recipe', 'recipe' ),
    description:                                   __(
        'Provides a short summary of a recipe', 'recipe'
    ),
    ...
    attributes: {
        ingredients: {
            type:                       'string', // type is only required if working with meta-data but still somewhat recommended
            source:                     'text',
            ...
            <InspectorControls>
                <PanelBody title={ __( 'Basics', 'recipe' ) }>
                    ...
                    <TextControl label={ __( 'Ingredients', 'recipe' ) } 
                                 help={ __( 'Ex: Tomatoes, Oil, Lettuce, etc', 'recipe' ) }
                    ...
                    <TextControl label={ __( 'Utensils', 'recipe' ) } 
                                 help={ __( 'Ex: Knife, Fork, Spoon, Pans, etc', 'recipe' ) }
                                 value={props.attributes.utensils}
                                 onChange={ (new_val) => {
                                    props.setAttributes({ utensils: new_val })
                                 } }
                    />
                    <SelectControl label={ __( 'Cooking Experience', 'recipe' ) }
                    ...
                    />
                    <SelectControl label={ __( 'Meal Type', 'recipe' ) }
